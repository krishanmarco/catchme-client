...
class LocalUser {
  static get() { return Realm.objects(LocalUser.schema.name); }
  static schema = {
    name: 'LocalUser',
    properties: {
      user:           {type: 'User'                                                                                 }
...
class User {
  static get() { return Realm.objects(User.schema.name); }
  static schema = {
    name: 'User',
    primaryKey: 'id',
    properties: {
...
class UserLocations {
  static get() { return Realm.objects(UserLocations.schema.name); }
  static schema = {
    name: 'UserLocations',
    properties: {
...
class UserConnections {
  static get() { return Realm.objects(UserConnections.schema.name); }
  static schema = {
...
class Location {
  static get() { return Realm.objects(Location.schema.name); }
  static schema = {
    name: 'Location',
    primaryKey: 'id',
    properties: {
...
class LocationConnections {
  static get() { return Realm.objects(LocationConnections.schema.name); }
  static schema = {
...
class UserLocationStatus {
  static get() { return Realm.objects(UserLocationStatus.schema.name); }
  static schema = {
...
class GenericObject {
  static get() { return Realm.objects(GenericObject.schema.name); }
  static schema = {
    name: 'GenericObject',
    properties: {
